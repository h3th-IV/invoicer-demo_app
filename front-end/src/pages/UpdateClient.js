...
const UpdateClient = () => {
  ...
  const fetchClientData = async () => {
    try {
      ...
      handleApiError(error, toast, 'Failed to load client data');
      navigate('/clients');
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      handleApiError(error, toast, 'Failed to update client');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Edit client information</p>
          </div>
        </div>
      </div>
